      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <NumberInput
            ...
            formControlProps={{
              id: 'time_logged',
              isInvalid: !!formik.errors?.time_logged,
            }}
            name="time_logged"
            error={formik.errors?.time_logged}
            value={formik.values?.time_logged}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('time_logged', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            error={formik.errors?.performance_evaluation}
