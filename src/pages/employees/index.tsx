...
export function EmployeeListPage(props: EmployeeListPageProps) {
  const { filters = {}, titleProps = {}, showSearchFilter = true, hidePagination, hideTableBorders } = props;
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<EmployeeInterface>>(() => '/employees', fetcher);
  ...
  const columns: ColumnType[] = [
    { id: 'time_logged', header: 'time_logged', accessorKey: 'time_logged' },
    { id: 'performance_evaluation', header: 'performance_evaluation', accessorKey: 'performance_evaluation' },
